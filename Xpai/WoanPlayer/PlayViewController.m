...
//        playView.bounds = CGRectMake(0, 0, kScreenH, kScreenW);
        
//        playView.transform = CGAffineTransformMakeRotation(M_PI / 2 * -1);
...
//        playView.transform = CGAffineTransformMakeRotation(2 /3 *M_PI);
        if ([[UIDevice currentDevice] respondsToSelector:@selector(setOrientation:)]) {
